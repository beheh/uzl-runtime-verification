...
public class MyDataClientTestSalt {
	...
	// to the data service.
	private static final Monitor commitBeforeClose = new SaltMonitor(
			"always(modify implies (not close until committed))");

	// Monitor checking that a data service is opened before data
	// modifications are performed.
	private static final Monitor openBeforeModify = new SaltMonitor(
			"(not modify until weak opened) and always(close implies (not modify until weak opened))");
